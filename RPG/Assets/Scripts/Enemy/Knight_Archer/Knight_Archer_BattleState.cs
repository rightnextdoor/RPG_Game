...
public class Knight_Archer_BattleState : EnemyState
{
    private Enemy_Knight_Archer enemy;
    private Transform player;
    public Knight_Archer_BattleState(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName, Enemy_Knight_Archer enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        this.enemy = enemy;
    }

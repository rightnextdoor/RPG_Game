...
public class Enemy_CatWarrior : Enemy_Boss
{
    ...
    public CatWarrior_EvasionState evasionState { get; private set; }
    #endregion
    ...
    protected override void Awake()
    {
        ...
        evasionState = new CatWarrior_EvasionState(this, stateMachine, "Move", this);
    }
    ...
    {
        GameObject castTornadoAttack = Instantiate(tornadoPrefab, transform.position, Quaternion.identity);

...
public class DeathBringerSpellCastState : EnemyState
{
    ...
    public DeathBringerSpellCastState(Enemy_Boss _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName, Enemy_DeathBringer _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        this.enemy = _enemy;
    }
